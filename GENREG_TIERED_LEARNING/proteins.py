...
class TrustModifierProtein(Protein):
    ...
    def forward(self, signals, protein_outputs):
        ...
        # --- REVISED HARD GATE PATCH: ENSURE POSITIVE SIGNAL ---
        # Trust is only granted if the input signal (e.g., token_hit=1.0) 
        # is definitively positive. This prevents non-zero floating-point noise 
        ...
        # Calculate Trust normally only if signal exists
